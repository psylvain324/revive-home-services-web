  ...
  return (
    <main className="admin-login-page">
      <div className="admin-login-art">
        <a href="/" className="admin-brand"><img src="/images/revive-co-logo.webp" alt="Revive Co" /></a>
  ...
  return (
    <div className="admin-shell">
      <aside className="admin-sidebar">
        <a className="admin-logo" href="/"><img src="/images/revive-co-logo.webp" alt="Revive Co" /></a>
